...
import com.jeffrey.project.card.rest.StateController;
...
public class PlayersList {
	...
	public void removePlayer(String name) {
		...
		if(currPlayer.next == master) {
			...
			//The player is master - must reassign a new master and point last player to new master
	...
	public List<String> getPlayerOrder(String currentPlayerName) {
		// Pass in the name of the current player to return the order of players starting with this player
